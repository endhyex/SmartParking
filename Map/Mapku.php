...
<html>
  ...
  <body>
    <div>
          ...
          <div>
        <form method="post" action="logout.php" class="pull-right position">
                  <div class="input-append">
                      <button class="btn btn-danger search-button" type="submit"><i class="fa fa-search"></i>LOGOUT</button>
                  </div>
    </form>
  </div>
                </nav>
